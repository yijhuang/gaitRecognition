...
class SetNet(nn.Module):
    def __init__(self, hidden_dim):
        ...
        self.layer2_3d = SetBlock3d(BasicConv3d(_set_channels[0], _set_channels[0], [3,3,3], padding=(1,1,1)),
            True, kernel_size=[2,2,2], stride=[2,2,2])
        ...
        #     True, kernel_size=[2,2,2], stride=[2,2,2])
        self.layer4_3d = SetBlock3d(BasicConv3d(_set_channels[1], _set_channels[1], [3,3,3], padding=(1,1,1)),
            True, kernel_size=[2,2,2], stride=[2,2,2])
        ...
        self.layer6_3d = SetBlock3d(BasicConv3d(_set_channels[2], _set_channels[2], [3,3,3], padding=(1,1,1)))

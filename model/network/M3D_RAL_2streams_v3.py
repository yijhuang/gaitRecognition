...
class SetNet3d(nn.Module):
    def __init__(self, hidden_dim,frame_num, num_classes):
        ...
        self.M3D_2 = SetBlock3d(M3D_3(_set_channels[0], _set_channels[0]))
        ...
        #self.RAL_2 = RAL(_set_channels[1], int(self.frame_num))
        
        self.M3D_3 = SetBlock3d(M3D_3(_set_channels[1], _set_channels[1]))
    ...
    def forward(self, silho, batch_frame=None, training=True):
        ...
        #feature = x_3d.matmul(self.fc_bin3d[0])

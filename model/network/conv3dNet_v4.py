...
class SetNet(nn.Module):
    def __init__(self, hidden_dim):
        ...
        _set_3d_channels = [32, 64, 128, 256]
        ...
        self.layer1_c2 = nn.ParameterList([
            nn.Parameter(
                nn.init.xavier_uniform_(
                    torch.zeros(_set_3d_channels[0],1,3)))])
        self.layer2_c2 = nn.ParameterList([
            nn.Parameter(
                nn.init.xavier_uniform_(
                    torch.zeros(_set_3d_channels[1],1,3)))])
        ...
        self.layer4_c2 = nn.ParameterList([
            nn.Parameter(
                nn.init.xavier_uniform_(
                    torch.zeros(_set_3d_channels[2],1,3)))])
        ...
        self.layer6_c2 = nn.ParameterList([
            nn.Parameter(
                nn.init.xavier_uniform_(
                    torch.zeros(_set_3d_channels[3],1,3)))])
        self.layer7_c2 = nn.ParameterList([
            nn.Parameter(
                nn.init.xavier_uniform_(
                    torch.zeros(_set_3d_channels[3],1,3)))])

        self.layer1_3d = SetBlock3d(BasicConv3d(_set_in_channels, _set_3d_channels[0], [1,3,3], padding=(0,1,1)),
            True, kernel_size=[1,2,2], stride=[1,2,2])
        self.layer2_3d = SetBlock3d(BasicConv3d(_set_3d_channels[0], _set_3d_channels[1], [1,3,3], padding=(0,1,1)),
            True, kernel_size=[2,1,1], stride=[2,1,1])
        self.layer3_3d = SetBlock3d(BasicConv3d(_set_3d_channels[1], _set_3d_channels[1], [1,3,3], padding=(0,1,1)),
            True, kernel_size=[2,1,1], stride=[2,1,1])
        self.layer4_3d = SetBlock3d(BasicConv3d(_set_3d_channels[1], _set_3d_channels[2], [1,3,3], padding=(0,1,1)),
            True, kernel_size=[1,2,2], stride=[1,2,2])
        self.layer5_3d = SetBlock3d(BasicConv3d(_set_3d_channels[2], _set_3d_channels[2], [1,3,3], padding=(0,1,1)),
            True, kernel_size=[2,1,1], stride=[2,1,1])
        #    True, kernel_size=[2,1,1], stride=[2,1,1])
        self.layer6_3d = SetBlock3d(BasicConv3d(_set_3d_channels[2], _set_3d_channels[3], [1,3,3], padding=(0,1,1)),
            True, kernel_size=[2,1,1], stride=[2,1,1])
        self.layer7_3d = SetBlock3d(BasicConv3d(_set_3d_channels[3], _set_3d_channels[3], [1,3,3], padding=(0,1,1)))
    ...
    def forward(self, silho, batch_frame=None):
        ...
        x_3d = self.layer1_3d(x_3d,self.layer1_c2)
        #x.shape : [128,30,32,32,22][batchsize,frame_num,channels,w,h]
        x_3d = self.layer2_3d(x_3d,self.layer2_c2)
        #self.frame_max(x)[0].shape = [128,32,32,22] gl.shape = [128,64,32,22]
        x_3d = self.layer3_3d(x_3d,self.layer3_c2)#self.frame_max[0]is data,self.frame_max[1] is indices
        #gl.shape = [128,64,32,22]
        x_3d = self.layer4_3d(x_3d,self.layer4_c2)
        #gl.shape = [128,64,16,11]
        x_3d = self.layer5_3d(x_3d,self.layer5_c2)
        x_3d = self.layer6_3d(x_3d,self.layer6_c2)
        x_3d = self.layer7_3d(x_3d,self.layer7_c2)

...
from .network import TripletLoss, SetNet, SetNet3d, CrossEntropyLabelSmooth
...
#             input()
        ...
        for seq, view, seq_type, label, batch_frame, seq_3d in train_loader:
            ...
            softmax_loss3d = self.softmax_loss(sfx_feature3d, sfx_label).mean()
            ...
            loss = loss + softmax_loss +softmax_loss3d
...
#                 self.dist_list = []
    ...
    def save(self):
        ...
        #state = {'gaitset':self.encoder2.state_dict(),
        #        }
        torch.save(state,

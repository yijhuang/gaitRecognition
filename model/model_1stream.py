...
from .network import TripletLoss, SetNet3d, CrossEntropyLabelSmooth, CenterLoss
...
#             input()
        ...
        for seq, view, seq_type, label, batch_frame in train_loader:
            ...
            feature3d, cls_score3d,label_prob3d = self.encoder2(*seq, batch_frame, self.training)
            ctr_feature = feature3d.permute(1, 0, 2).contiguous()
            ...
            #feature = feature3d
            triplet_feature = feature3d.permute(1, 0, 2).contiguous()
            ...
            sfx_feature = cls_score3d.permute(1, 0, 2).contiguous()
            ...
            #loss = loss + softmax_loss + 0.0005 * center_loss
...
#             # softmax_loss = self.softmax_loss(feature, label_softmax).mean()
#             if self.hard_or_full_trip == 'hard':
#                 loss = hard_loss_metric.mean()
#             elif self.hard_or_full_trip == 'full':
#                 loss = full_loss_metric.mean()
...
#                 self.dist_list = []
    ...
    def transform(self, flag, batch_size=1):
        ...
        for i, x in enumerate(data_loader):
            ...
            seq, view, seq_type, label, batch_frame = x    #(seq:frameset,view:angle,seq,label,batch_frame:frame_num)
            ...
            feature_3d, _ = self.encoder2(*seq, None, self.training)
            ...
            #feature_3d_list.append(feature_3d.view(n,-1).data.cpu().numpy())
            view_list += view
    ...
    def load(self, restore_iter):
        ...
        self.encoder2.load_state_dict(checkpoint['conv3dNet'])
